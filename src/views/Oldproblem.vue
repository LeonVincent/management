  ...
  <div class="new_problem">
    <ul>
      <li v-for="(item,index) in list">
        ...
        <el-row class="explan">
          <el-col :xs="22" :sm="22" style="word-break: break-all;"><span v-show="!item.isread" class="isread"></span>{{item.title}}</el-col>
          <el-col :xs="2" :sm="2">
...
export default {
  ...
  methods: {
    ...
    getList(){
      ...
      this.$api.get('customerservice/admin/pastlist',obj, function (data) {
        var data = data.data;
